    ...
    for char in available:
        ...
        for index in range(len(mask)):
            ...
            # The third case is that the other chars have not been guessed
                ...
                if not mask[index - 2] == '' and not mask[index - 1] == '':
                ...
                elif mask[index - 2] == '' and not mask[index - 1] == '':
    ...
    for char in available:
        ...
        for index in range(len(mask)):
            ...
            if index == 2 and mask[index] == '_':
                if not mask[index - 1] == '' and not mask[index - 2] == '':
